...
<xsl:template match="iot">
  <html>
      ...
      <style type="text/css">
        ...
        #clockarea { position: absolute; top: 8px; right: 40px; color: #FFFF00; font-family: digital-7regular; letter-spacing: 7px; font-weight: bold; font-size: 36pt; }
