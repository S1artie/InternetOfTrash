...
<xsl:template match="iot">
  <html>
      ...
      <style type="text/css">
        ...
        #clockarea { position: absolute; top: 4px; right: 50px; color: #FFFF00; font-family: digital-7regular; letter-spacing: 7px; font-weight: bold; font-size: 36pt; }
        ...
        #labelprinter { position: absolute; top: 15px; left: 100px; z-index: 10; width: 780px; height: 370px; background: rgba(0,0,0,0.9); border: 2px solid #fff; border-radius: 20px 10px; box-shadow: 0px 0px 0px 200px rgba(0,0,0,0.7);  }
