...
<xsl:template match="iot">
  <html>
      ...
      <style type="text/css">
        ...
        body { color-scheme: light only; font-family: Calibri, Arial, sans-serif; font-size: 16pt; color: #fff; margin: 0px; display: block; border-collapse: collapse; width: 100%; height: 100%; background-color: #1c1c1c; }
